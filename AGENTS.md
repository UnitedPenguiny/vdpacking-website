# VD Packing Website — ChatGPT / Codex Agent Instructions

These are the default project rules for ChatGPT, Codex, and other coding agents working in this repository. They describe the repository, the safe Git workflow, and the current production expectations.
...
Keep this file and the repository’s `CLAUDE.md` aligned when project rules change.
